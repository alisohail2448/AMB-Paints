...
const Contact = () => {
  return (
<section className="relative z-10 overflow-hidden bg-white py-20 lg:py-[80px] px-4 ">
    ...
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-8 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          ...
          <h2
            className="text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px] text-[#4d3286]"
          >
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold text-[#4d3286]">Our Location</h4>
              <p className="text-body-color text-base">
              D-25 Mahesh Nagar,<br /> Shanti Nagar Nagpur 440002
              </p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold text-[#4d3286]">Phone Number</h4>
              <p className="text-body-color text-base">+91 8-9999-4545-9</p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div className="w-full">
              <h4 className="text-dark mb-1 text-xl font-bold text-[#4d3286]">Email Address</h4>
              <p className="text-body-color text-base">ambpaintsnagpur@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="relative rounded-lg bg-gray-100 p-8 sm:p-12">
          <form>
            ...
            <div>
              <button
                type="submit"
                className="bg-[#4d3286] border-none rounded-md w-full border p-3 text-white hover:bg-opacity-90 transition-all"
              >
                Send Message
              </button>
            </div>
