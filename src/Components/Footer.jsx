        ...
        <div className="-mx-4 flex flex-wrap justify-between ">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full ">
              <Link
                to="/"
                className="mb-6 max-w-[160px] flex flex-col items-center"
              >
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-[20%]">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold text-[#4d3286]">
              OUR COATINGS FOR
              </h4>
              <ul>
                <li>
