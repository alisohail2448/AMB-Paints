...
const Footer = () => {
  return (
    <footer className="relative z-10 px-4 bg-gray-100 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full ">
              <Link to="/" className="mb-6 max-w-[160px] flex flex-col items-center">
                <img
                  src={logo}
                  alt="logo"
                  width={100}
              ...
              <p className="text-dark flex items-center text-sm font-medium mb-4">
              ...
              >
                ...
                <span>D-25 Mahesh Nagar,<br /> Shanti Nagar Nagpur 440002</span>
              </p>
              <p className="text-dark flex items-center text-sm font-medium">
                ...
                <span>+91 8-9999-4545-9</span>
              </p>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold text-[#4d3286]">Resources</h4>
              <ul>
                <li>
                  <a
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold text-[#4d3286]">Company</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold text-[#4d3286]">Quick Links</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold text-[#4d3286]">Follow Us On</h4>
              ...
              <p className="text-body-color text-base">&copy; 2023 AMB Paints</p>
            </div>
          </div>
        </div>
      </div>
